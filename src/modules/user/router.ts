...
userRouter.post('/register/admin', authMiddleware, roleMiddleware(['admin','manager','user']),(req, res) => {
            res.json({message: "welcome user"})}, bodyValidator(loginUserSchema), loginUser);
